...
${opts.description || 'Proyecto generado con Basalt AI — Creator IA Pro.'}
...
---
Generado con [Basalt AI](https://creator-ia.com)
`);
...
export const metadata: Metadata = {
  ...
  description: '${opts.description || 'Built with Basalt AI'}',
};
