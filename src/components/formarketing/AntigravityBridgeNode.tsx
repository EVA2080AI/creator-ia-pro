  ...
  return (
    ...
    `}>
      ...
      <div className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 z-50">
        <div className="w-4 h-4 rounded-full bg-violet-500 border-2 border-white shadow-md cursor-crosshair hover:scale-125 transition-transform"
             style={{ boxShadow: '0 0 8px rgba(139, 92, 246, 0.6), 0 0 0 2px white' }}>
