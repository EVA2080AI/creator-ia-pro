        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="absolute right-0 bottom-full mb-2 w-[26rem] max-w-[calc(100vw-2rem)] rounded-2xl overflow-hidden z-[100] bg-white border border-zinc-200 shadow-[0_20px_60px_rgba(0,0,0,0.12)]"
            >
              {/* Header */}
