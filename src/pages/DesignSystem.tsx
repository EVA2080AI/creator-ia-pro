    ...
    <div className="min-h-screen bg-white flex">
      ...
      <main className="flex-1 min-w-0 bg-white">
        ...
        <div className="px-8 lg:px-20 py-24 space-y-32 max-w-6xl">
          ...
          {/* Section: Industrial Sovereign (v19.5) */}
          <section id="industrial" className="scroll-mt-24 p-12 rounded-[48px] bg-zinc-900 text-white relative overflow-hidden border border-white/5">
            <div className="absolute top-0 right-0 w-1/2 h-full opacity-20 pointer-events-none">
              <div className="absolute top-1/2 right-0 -translate-y-1/2 w-[400px] h-[400px] bg-primary rounded-full blur-[100px]" />
            </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="inline-flex p-1.5 bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl relative">
                      <div className="flex items-center relative z-10 h-10">
                        <button className="px-6 h-full flex items-center gap-2 rounded-xl bg-primary text-white text-[10px] font-black uppercase tracking-widest shadow-xl shadow-primary/20 transition-all">
                  ...
                  <div className="p-8 rounded-[2.5rem] bg-white/5 border border-white/10 backdrop-blur-md space-y-6">
                    ...
                    <div className="space-y-4">
                      <div className="h-2 w-full bg-white/5 rounded-full overflow-hidden">
                        <div className="h-full w-[45%] bg-primary shadow-lg shadow-primary/20" />
                      </div>
                    ...
                    <div className="p-6 rounded-[2rem] bg-white text-zinc-900 shadow-2xl space-y-4 border border-zinc-100">
                      <div className="flex justify-between items-end">
                        ...
                        <div className="text-right">
                          <p className="text-[18px] font-black italic text-primary">120 / 150</p>
                        </div>
                      </div>
                      <div className="h-4 w-full bg-zinc-50 rounded-full border border-zinc-100 overflow-hidden p-1">
                        <div className="h-full w-[80%] rounded-full bg-gradient-to-r from-primary via-indigo-400 to-primary shadow-sm" />
                      </div>
                      <div className="flex justify-between items-center pt-2">
                        ...
                        <button className="text-[10px] font-black uppercase text-primary tracking-widest hover:underline italic">Recargar →</button>
                      </div>
                    </div>
                  </div>
          ...
          {/* Section: Atomic (V7) */}
          <section id="atomic" className="scroll-mt-24 border-t-4 border-primary pt-24">
            <div className="flex items-center gap-4 mb-12">
              <div className="h-10 w-10 rounded-xl bg-primary flex items-center justify-center text-white shadow-lg shadow-primary/20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              {/* Atomic Tokens */}
              <div className="space-y-8">
                <h3 className="text-sm font-black text-zinc-400 uppercase tracking-widest border-l-2 border-primary pl-4">Tokens de Diseño (HSL)</h3>
              ...
              <div className="space-y-8 text-left">
                <h3 className="text-sm font-black text-zinc-400 uppercase tracking-widest border-l-2 border-primary pl-4">Funcionalidades Studio V7</h3>
                <div className="space-y-6">
                  <div className="p-6 rounded-2xl bg-zinc-50 border border-zinc-200 group">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="h-8 w-8 rounded-lg bg-white border border-zinc-200 flex items-center justify-center text-zinc-900 group-hover:bg-primary group-hover:text-white transition-all">
