  ...
  const faqs = [
    {
      ...
      answer:
        "Crea una cuenta gratuita en /auth y recibe 5 créditos para explorar. Desde el Dashboard, accede a Genesis IA para crear apps o Aplicaciones para imágenes y texto.",
