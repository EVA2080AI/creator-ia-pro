  ...
  if (loading) {
    return (
      <div className="flex h-screen items-center justify-center bg-[#0a0a0b]">
        <Loader2 className="h-8 w-8 animate-spin text-[#ff0071]" />
      </div>
    );
  }

  return (
    <div className="min-h-screen bg-[#0a0a0b] text-white font-sans selection:bg-[#ff0071]/30">
      ...
      <main className="container mx-auto px-6 py-12 max-w-6xl animate-in fade-in slide-in-from-bottom-4 duration-1000">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 border-b border-white/5 pb-12">
           <div className="space-y-4">
              ...
              <h1 className="text-5xl font-black tracking-tighter text-white lowercase leading-none">
                perfil_de_<span className="text-[#ff0071]">usuario</span>
              </h1>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            <Card className="rounded-[2.5rem] border-white/5 bg-white/5 backdrop-blur-2xl shadow-2xl p-4 overflow-hidden group">
              <CardHeader className="pb-8">
                ...
                <CardTitle className="text-2xl font-bold tracking-tight lowercase text-white">detalles de cuenta</CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="name" className="text-[10px] font-bold text-slate-400 uppercase tracking-widest pl-1">nombre_público</Label>
                    <Input 
                      id="name" 
                      value={displayName} 
                      onChange={(e) => setDisplayName(e.target.value)}
                      placeholder="tu nombre..."
                      className="h-14 bg-white/5 border-white/5 rounded-2xl text-white placeholder:text-slate-600 focus:ring-[#ff0071]/20 focus:border-[#ff0071]/40 transition-all font-bold"
                    />
                  </div>
                </div>
                ...
                <div className="pt-4 flex justify-end">
                  <Button 
                    ...
                    disabled={saving}
                    className="bg-[#ff0071] hover:bg-[#e60066] text-white rounded-2xl h-12 px-8 font-bold lowercase shadow-xl shadow-[#ff0071]/20 active:scale-95 transition-all"
                  >
            ...
            <div className="space-y-6 pt-2">
              <div className="flex items-center justify-between p-4 rounded-2xl bg-white/[0.02] border border-white/5">
                <div className="space-y-1">
                  <span className="text-[10px] font-black text-[#ff0071] uppercase tracking-widest">nexus_core_mode</span>
                  <p className="text-[11px] text-slate-400">prioriza creatividad o precisión visual.</p>
                </div>
                <Select value={settings.nexus_mode} onValueChange={(v) => setSettings({...settings, nexus_mode: v})}>
                  ...
                  <SelectContent className="bg-[#0a0a0b] border-white/10 text-white">
                    <SelectItem value="creative" className="text-[10px] font-bold">creativo</SelectItem>
                    <SelectItem value="precise" className="text-[10px] font-bold">preciso</SelectItem>
                    <SelectItem value="fast" className="text-[10px] font-bold">veloz</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            ...
            <Card className="rounded-[2.5rem] border-white/5 bg-white/5 backdrop-blur-2xl p-8 hover:bg-white/[0.07] transition-all group">
              ...
              <h3 className="text-lg font-bold lowercase mb-2">integración_nube</h3>
              <p className="text-xs text-slate-400 lowercase mb-6 leading-relaxed">conecta google drive para respaldos automáticos de activos.</p>
              <Button variant="ghost" className="p-0 h-auto text-blue-500 font-bold text-xs lowercase gap-2 hover:bg-transparent">
          ...
          <div className="space-y-8">
            <Card className="rounded-[2.5rem] border-white/5 bg-[#ff0071] shadow-2xl shadow-[#ff0071]/20 p-8 text-white relative overflow-hidden group">
               <div className="absolute -right-10 -top-10 h-32 w-32 rounded-full bg-white/10 blur-3xl group-hover:bg-white/20 transition-all" />
               <div className="relative z-10 space-y-6">
                  <div className="flex items-center justify-between">
                     <Coins className="h-8 w-8" />
                     <Badge className="bg-white/20 text-white border-transparent backdrop-blur-md rounded-full px-3 py-0.5 text-[9px] font-bold uppercase tracking-widest">
                        balance_actual
                     </Badge>
                  </div>
                  <div>
                     <span className="text-6xl font-black tracking-tighter leading-none">{profile?.credits_balance || 0}</span>
                     <span className="text-sm font-bold opacity-60 ml-2">credits</span>
                  </div>
                  <Button 
                    onClick={handleRecharge}
                    className="w-full bg-white text-[#ff0071] hover:bg-slate-50 rounded-2xl h-12 font-bold lowercase shadow-xl active:scale-95 transition-all mt-4"
                  >
                     recargar_créditos
                  </Button>
               </div>
            ...
            <Card className="rounded-[2.5rem] border-white/5 bg-white/5 backdrop-blur-2xl p-8 space-y-6">
               ...
               <div className="space-y-4">
                  <div className="flex items-center justify-between">
                     <span className="text-xs font-bold text-slate-300 lowercase">plan_actual</span>
                     <Badge className="bg-[#ff0071]/10 text-[#ff0071] border-transparent rounded-full px-3 py-1 text-[10px] font-black uppercase">
               ...
               <div className="pt-6 border-t border-white/5">
                  ...
                  <div className="flex items-center gap-3 p-4 rounded-2xl bg-white/5 border border-white/5">
                     <Bell className="h-4 w-4 text-[#ff0071]" />
                     <span className="text-[10px] font-bold text-slate-300 lowercase leading-tight">recibir alertas de balance bajo y actualizaciones Nexus.</span>
                  </div>
               </div>
            </Card>
          </div>
