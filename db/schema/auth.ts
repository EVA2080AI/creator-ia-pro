...
export const account = pgTable(
  "account",
  {
    ...
    // Añadido a mano: better-auth 1.7 lo requiere en el core (account_schema.ts),
    // el CLI @better-auth/cli 1.4.21 aún no lo genera.
...
// ── Perfil de producto (créditos, plan) — 1:1 con `user`, fuera del núcleo de better-auth ──
